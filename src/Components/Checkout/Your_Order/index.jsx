                ...
                {cart.map(
                  (product) =>
                    product && (
                      <li
                        key={product.id}
                        className={checkoutStyles.your_product_items}
                      >
                        <div
                          className={checkoutStyles.your_order_titles_mobile}
                        >
                          <p
                            className={checkoutStyles.your_product_title_mobile}
                          >
                            Product
                          </p>
                          <p
                            className={
                              checkoutStyles.your_subtotal_title_mobile
                            }
                          >
                            Subtotal
                          </p>
                        ...
                        <div
                          className={checkoutStyles.your_products_in_cart_div}
                        >
                          <div className={checkoutStyles.your_image_div}>
                            <img
                              className={checkoutStyles.your_image}
                              src={product.image.url}
                              alt={product.title}
                            />
                          </div>
                          <div>
                            <p className={checkoutStyles.product_title}>
                              {product.title}
                            </p>
                          </div>
