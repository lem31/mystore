...
function PaymentForm() {
  ...
  return (
    <div className={checkoutStyles.payment_form_box}>
      <form
        className={checkoutStyles.payment_form}
        onSubmit={(e) => {
          e.preventDefault();
          handleClick();
        }}
      >
        ...
        <div className={styles.row_div}>
          <div className={checkoutStyles.label_input_div}>
            <label
              className={checkoutStyles.checkout_label}
              htmlFor="name"
            >
              Name
            </label>
            <input
              className={checkoutStyles.checkout_first_name}
              type="text"
              id="first-name"
              name="first-name"
          ...
          <div className={checkoutStyles.label_input_div}>
            ...
            <input
              className={checkoutStyles.checkout_last_name}
              type="text"
              id="last-name"
              name="last-name"
        ...
        <input
          className={checkoutStyles.checkout_input}
          type="text"
          id="company"
          name="company"
          placeholder="company"
        ...
        <div className={checkoutStyles.row_div}>
          <div className={checkoutStyles.label_input_div}>
            ...
            <input
              className={checkoutStyles.checkout_house_no}
              type="text"
          ...
          <div className={checkoutStyles.label_input_div}>
            <label
              className={checkoutStyles.checkout_label}
              htmlFor="apartment-building-number"
            >
              Apartment, Building Number, etc.
            </label>
            <input
              className={checkoutStyles.checkout_building}
              type="text"
              id="apartment-building-number"
              name="apartment-building-number"
              placeholder="Apartment, Building Number, etc."
            />
          </div>
        </div>
        <div className={checkoutStyles.row_div}>
          <div className={checkoutStyles.label_input_div}>
            ...
            <input
              className={checkoutStyles.input_town_zip_state}
              type="text"
              id="town-city"
              name="town-city"
        ...
        <input
          ...
          placeholder="Additional details about your order. E.G. specific info about delivery"
        />
        ...
        <ul className={checkoutStyles.payment_options_ul}>
            ...
            <div className={checkoutStyles.card_img_row_div}>
              <label htmlFor="option1">
                <div className={checkoutStyles.option_one_row_div}>
                  ...
                  <img
                    className={checkoutStyles.card_img}
                    src={CreditCard}
                    alt="Option 1"
                  />
          ...
          <div className={styles.card_payment_form_container}>
            <div className={styles.card_payment_form_div}>
              ...
              <input
                className={checkoutStyles.checkout_card_no}
                type="number"
                id="card-number"
                name="card-number"
              ...
              <div className={checkoutStyles.row_div}>
                <div className={checkoutStyles.label_input_div}>
                  ...
                  <input
                    className={checkoutStyles.checkout_expiry}
                    type="text"
                    id="expiry-date"
                    name="expiry-date"
                ...
                <div className={checkoutStyles.label_input_div}>
                  ...
                  <input
                    className={checkoutStyles.checkout_cvc}
                    type="number"
                    id="cvc-cvv"
                    name="cvc-cvv"
                    placeholder="CVC/CVV"
              ...
              <input
                className={checkoutStyles.checkout_name_on_card}
                type="text"
                id="name-on-card"
                name="name-on-card"
          ...
          <li className={checkoutStyles.payment_option_li}>
            <div
              className={`${checkoutStyles.payment_option_row} ${checkoutStyles.klarna_div}`}
            >
              <input
                type="radio"
                id="option2"
              ...
              <label htmlFor="option2">
                <div className={checkoutStyles.img_p_div}>
                  <img
                    className={checkoutStyles.klarna_img}
                    src={Klarna}
                    alt="Option 2"
                  />
          ...
          <li className={checkoutStyles.payment_option_li}>
            <div
              className={`${checkoutStyles.payment_option_row} ${checkoutStyles.vipps_div}`}
            >
              <input
                type="radio"
                id="option3"
              ...
              <label htmlFor="option3">
                <div className={checkoutStyles.img_p_div}>
                  <img
                    className={checkoutStyles.vipps_img}
                    src={Vipps}
                    alt="Option 3"
                  />
